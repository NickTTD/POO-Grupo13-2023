...
• Debe permitir registrar Compras que hacen los Clientes. Cada Compra tiene un detalle de
...
• Las Lineas de Compra que conforman el Detalle de la Compra, relacionan la Compra con el
Producto y especifican la cantidad comprada.
La aplicación debe permitir:
• Registrar un Cliente. Todos los campos son requeridos.
◦ El nombre debe tener al menos 2 caracteres.
◦ El cuit debe tener un formato válido (buscar algoritmo de validación de cuit).
...
◦ El nombre debe tener al menos 2 caracteres.
◦ El tipo de producto debe ser un enumerado. (Puede elegir que tipo de producto va a tener
en el enumerado).
...
◦ Para cada Línea de Compra el Producto debe existir y la cantidad debe ser > 0 y <= al
stock del Producto.

La Compra debe implementar un método getTotal() que devuelva la sumatoria de los subtotales de
cada Línea de Compra.
La Línea de Compra debe implementar un método getSubTotal() que devuelva la multiplicación de
...
El esquema de Promociones debe ser flexible y permitir agregar o quitar fácilmente Promociones.
La Promoción que corresponde se debe asignar al finalizar la carga de la Compra.
Para una compra sólo se puede asignar una Promoción.
La Promoción asignada afecta al valor que devuelve el método getTotal() de la Compra.*/